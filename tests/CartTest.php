...
use Tuta\Shoppingcart\Cart;
use Tuta\Shoppingcart\Contracts\Buyable;
use Tuta\Shoppingcart\Contracts\Taxable;
...
class CartTest extends Orchestra\Testbench\TestCase
{
    ...
    {
        return [\Tuta\Shoppingcart\ShoppingcartServiceProvider::class];
    }
    ...
    public function it_will_return_the_cartitem_of_the_added_item()
    {
        ...
        $this->assertInstanceOf(\Tuta\Shoppingcart\CartItem::class, $cartItem);
    ...
    public function it_will_return_an_array_of_cartitems_when_you_add_multiple_items_at_once()
    {
        ...
        $this->assertContainsOnlyInstancesOf(\Tuta\Shoppingcart\CartItem::class, $cartItems);
    }
    ...
    /**
     * @test
     * @expectedException \Tuta\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    public function it_will_include_the_tax_and_subtotal_when_converted_to_an_array()
    {
        ...
        $this->assertEquals([
            '027c91341fd5cf4d2579b49c4b6a90da' => [
                ...
                'tax' => 2.10,
                'subtotal' => 10.0,
                'options' => new \Tuta\Shoppingcart\CartItemOptions,
            ],
    ...
    public function it_can_search_the_cart_for_a_specific_item()
    {
        ...
        $this->assertInstanceOf(\Tuta\Shoppingcart\CartItem::class, $cartItem->first());
    ...
    public function it_will_associate_the_cart_item_with_a_model_when_you_add_a_buyable()
    {
        ...
        $this->assertContains('Tuta_Shoppingcart_Contracts_Buyable', PHPUnit_Framework_Assert::readAttribute($cartItem, 'associatedModel'));
    }
    ...
    /**
     * @test
     * @expectedException \Tuta\Shoppingcart\Exceptions\UnknownModelException
    ...
    /**
     * @test
     * @expectedException \Tuta\Shoppingcart\Exceptions\CartAlreadyStoredException
